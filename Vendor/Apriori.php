...
namespace PaulRecommend\Vendor;

use PaulRecommend\Vendor\Predictable;
use PaulRecommend\Vendor\Trainable;
...
class Apriori implements Associator
{
     ...
     * pool.
     *
     * @see \PaulRecommend\Vendor\Apriori::samples
     *
     * @param mixed[] $sample
     *
     * @return float
     ...
     *
     * @see \PaulRecommend\Vendor\Apriori::equals()
     *
     * @param mixed[][] $system
     * @param mixed[]   $set
     *
